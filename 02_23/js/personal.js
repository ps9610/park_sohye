...
;(function($,window,document,undefined){
    var personal = {
        ...
        section2Fn : function(){
            ...
            _titleBtn2.on("click", function(){
                if( t===false ){
                    ...
                    _this.removeClass("addUp");
                    _this.addClass("addDown");
                    _rightContent2.stop().animate({ marginTop : -130 },500);
                }
                else{
                    t=false;
                    console.log(t);
        ...
        section3Fn : function(){
            ...
            var _slideView = $("#section3 .slide-view");
            ...
            var _slideH = _slideW*_slideHRate; 
            var _slideHRate = 1.3146400456;
            var _slideMargin = 30;
            var n = _slide.length;
            var _slideWrapW = (_slide.innerWidth()+_slideMargin)*n

            //resize function
            setTimeout(resizeFn,10);
            function resizeFn(){
                _slideW = _slide.css({ width : (_slideContainerW*_slideWRate) });
                _slideH = _slideW*_slideHRate;
                _slideWrapW = (_slide.innerWidth()+_slideMargin)*n;

                _slide.css({ width : _slideW });
                _slide.css({ height : _slideH });
                _slideWrap.css({ width : _slideWrapW });
                console.log( _slideWrapW )
            }
            _window.resize(function(){
                resizeFn();
            })
            ...
            //slide
            function mainSlideFn(){
                _slideWrap.stop().animate({ left : -(_slideW+30)*cnt },500);
            }
